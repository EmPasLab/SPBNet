...
do 
  pretrained_1_32=./results/$data/checkpoint_1_32_${day}_2022${ver}_seeds${seed}.pth.tar
  pretrained_1_1=./results/$data/checkpoint_1_1_${day}_2022${ver}_seeds${seed}.pth.tar
  epochs=256
  epochs1=25
  
  iter1=( 1 32 0.0005 ${epochs} 0.00001 lambda adam )
  iter2=( 1 1  0.0005 ${epochs} 0.00000 lambda adam ${pretrained_1_32} )
  iter3=( 1 1  0.000005 ${epochs1} 0.00000 lambda adam ${pretrained_1_1} )
  ...
  do
    ...
    then
      ...
      python3 ${python} --a_bits=${mode[0]} --w_bits=${mode[1]} --learning_rate=${mode[2]} --epochs=${mode[3]} --weight_decay=${mode[4]} \
                        ...
                        --label_smooth=${label_smooth} --data=./data/imagenet --workers=${workers} --batch_size=${batch_size} --seed=${seed} --momentum=0.9 \
                        --outputfile=./results/$data/${mode[0]}_${mode[1]}_training_${day}_2022${ver}_${arr}_seeds${seed}.out --save=./results/$data --board=./results/$data/board\
